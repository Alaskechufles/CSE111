""" I defined constants outside the functions to store values instead of writing them directly inside them. This helps ensure that if we need to modify the constant values, we don’t have to manually change them in each function """
...
WATER_DYNAMIC_VISCOSITY=0.0010016  # (pascal second) or (kilogram / (meter second))
